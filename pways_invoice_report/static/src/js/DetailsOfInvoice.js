odoo.define('pways_invoice_report.DetailsOfInvoice', function (require) {
    'use strict';
    ...
    class DetailsOfInvoice extends PosComponent {
        constructor() {
            super(...arguments);
        ...
        async _downloadInvoice(orderId) {
            try {
                ...
                if (orderWithInvoice && orderWithInvoice.account_move) {
                    await this.env.pos.do_action('pways_invoice_report.action_report_invoice_report_details_inherit', {
                        additional_context: {
    ...
    DetailsOfInvoice.template = 'DetailsOfInvoice';
    Registries.Component.add(DetailsOfInvoice);

    return DetailsOfInvoice;
});