odoo.define('pways_invoice_report.InvoiceButtonDetails', function (require) {
    'use strict';
    ...
    class InvoiceButtonDetails extends PosComponent {
        constructor() {
            super(...arguments);
        ...
        async _downloadInvoice(orderId) {
            try {
                ...
                if (orderWithInvoice && orderWithInvoice.account_move) {
                    await this.env.pos.do_action('pways_invoice_report.action_report_invoice_report_inherit', {
                        additional_context: {
    ...
    InvoiceButtonDetails.template = 'InvoiceButtonDetails';
    Registries.Component.add(InvoiceButtonDetails);

    return InvoiceButtonDetails;
});